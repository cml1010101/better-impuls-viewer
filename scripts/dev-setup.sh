...
echo ""
echo "  Option 1 - One-command development (recommended):"
echo "    npm run dev"
echo ""
echo "  Option 2 - Full development with hot reload:"
echo "    Terminal 1: cd backend && python3 server.py"
echo "    Terminal 2: cd frontend && npm run dev"  
echo "    Terminal 3: npm run dev-simple"
echo ""
echo "  Option 3 - Quick start (if frontend already running):"
